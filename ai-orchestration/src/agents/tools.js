...
export const listFiles = tool(
    async ({ }) => {
        ...
        const response = await axios.get("http://sandbox-service-019e513a-7d79-744d-a487-e79ff07aa673:3000/list-files")
...
export const readFiles = tool(
    async ({ files: [] }) => {
        ...
        const response = await axios.get("http://sandbox-service-019e513a-7d79-744d-a487-e79ff07aa673:3000/read-files?files=" + files.join(","))
...
export const updateFiles = tool(
    async ({ files }) => {
        ...
        const response = await axios.patch("http://sandbox-service-019e513a-7d79-744d-a487-e79ff07aa673:3000/update-files", {
            updates: files
        })
        console.log("=================================")
